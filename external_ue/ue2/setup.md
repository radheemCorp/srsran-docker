...
Use this when running only one external UE from host_ue2.

1. In `.env`, set:
   - `UE_ZMQ_MODE=direct`
2. Ensure gNB `ru_sdr.device_args.rx_port` points to UE2 IP: `10.10.3.235:2001`.
3. Start container:
